# AI Content Risk Score - Codex Guide
...
- Each Codex agent gets its own **worktree** (isolated copy of the code)
...
- Worktree folders (`.Codex/worktrees/*/`) are on their own branches
...
- AGENTS.md Known Theater section updated — all 6 items resolved
